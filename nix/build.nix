...
let
  ...
  commonArgs =
    let
      velaCargoLock = builtins.fromTOML (builtins.readFile ../crates/vela/Cargo.toml);
      stdenv' = stdenv;
    in
    rec {
      pname = "vela-editor";
      version =
        velaCargoLock.package.version
        + "-nightly"
      ...
      nativeBuildInputs = [
        ...
        # See https://github.com/vela-industries/vela/pull/44012
      ...
      cargoExtraArgs = "-p vela -p cli --locked --features=gpui_platform/runtime_shaders";
      ...
      env = {
        ...
        VELA_UPDATE_EXPLANATION = "Vela has been installed using Nix. Auto-updates have thus been disabled.";
        RELEASE_VERSION = version;
        VELA_COMMIT_SHA = lib.optionalString (commitSha != null) "${commitSha}";
...
craneLib.buildPackage (
  lib.recursiveUpdate commonArgs {
    ...
    # https://github.com/vela-industries/vela/issues/19971#issuecomment-2688455390
    ...
    installPhase =
      if stdenv.hostPlatform.isDarwin then
        ''
          ...
          # Vela expects git next to its own binary
          ...
          ln -s "$out/Applications/Vela Nightly.app/Contents/MacOS/cli" $out/bin/vela
        ...
        ''
          ...
          cp $TARGET_DIR/vela $out/libexec/vela-editor
          cp $TARGET_DIR/cli  $out/bin/vela
          ln -s $out/bin/vela $out/bin/velaitor  # home-manager expects the CLI binary to be here


          install -D "crates/vela/resources/app-icon-nightly@2x.png" \
            "$out/share/icons/hicolor/1024x1024@2x/apps/vela.png"
          install -D crates/vela/resources/app-icon-nightly.png \
            $out/share/icons/hicolor/512x512/apps/vela.png

          # TODO: icons should probably be named "vela-nightly"
          (
            export DO_STARTUP_NOTIFY="true"
            export APP_CLI="vela"
            export APP_ICON="vela"
            export APP_NAME="Vela Nightly"
            export APP_ARGS="%U"
            mkdir -p "$out/share/applications"
            ${lib.getExe envsubst} < "crates/vela/resources/vela.desktop.in" > "$out/share/applications/dev.vela.Vela-Nightly.desktop"
            chmod +x "$out/share/applications/dev.vela.Vela-Nightly.desktop"
          )
    ...
    postFixup = lib.optionalString stdenv.hostPlatform.isLinux ''
      wrapProgram $out/libexec/vela-editor --suffix PATH : ${lib.makeBinPath [ nodejs_22 ]}
    '';

    meta = {
      description = "High-performance, multiplayer code editor from the creators of Atom and Tree-sitter";
      homepage = "https://vela.dev";
      changelog = "https://vela.dev/releases/preview";
