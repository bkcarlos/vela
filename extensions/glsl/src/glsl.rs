    ...
    fn language_server_binary_path(
        ...
        let asset_name = format!(
            ...
            arch = match arch {
                ...
                vela::Architecture::X86 => "x86",
                vela::Architecture::X8664 => "x86_64",
            },
            os = match platform {
                vela::Os::Mac => "macos",
                vela::Os::Linux => "linux-musl",
                vela::Os::Windows => "windows",
            }
        );
        ...
        if !fs::metadata(&binary_path).is_ok_and(|stat| stat.is_file()) {
            ...
            vela::download_file(
                ...
                &version_dir,
                match platform {
                    vela::Os::Mac | vela::Os::Linux => vela::DownloadedFileType::Zip,
                    vela::Os::Windows => vela::DownloadedFileType::Zip,
                },
            )
            .map_err(|e| format!("failed to download file: {e}"))?;

            vela::make_file_executable(&binary_path)?;
...
impl vela::Extension for GlslExtension {
    fn new() -> Self {
        Self {
    ...
    fn language_server_workspace_configuration(
        &mut self,
        _language_server_id: &vela::LanguageServerId,
        worktree: &vela::Worktree,
...
vela::register_extension!(GlslExtension);
