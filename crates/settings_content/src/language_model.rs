...
pub struct AllLanguageModelSettingsContent {
    ...
    #[serde(rename = "vela.dev")]
    pub vela_dot_dev: Option<VelaDotDevSettingsContent>,
}
...
pub struct AnthropicSettingsContent {
    ...
    /// Deprecated for the built-in Anthropic provider (always uses `X-Api-Key`).
...
pub struct AnthropicCompatibleSettingsContent {
    pub api_url: String,
    /// Authentication header format for this compatible Anthropic gateway.
    /// Defaults to `x_api_key`; some gateways require `bearer`.
    pub auth_mode: Option<AnthropicAuthMode>,
...
pub struct AnthropicCompatibleAvailableModel {
    ...
    pub name: String,
    /// The model's name in Vela's UI, such as in the model selector dropdown menu in the assistant panel.
...
pub struct AnthropicAvailableModel {
    ...
    pub name: String,
    /// The model's name in Vela's UI, such as in the model selector dropdown menu in the agent panel.
    pub display_name: Option<String>,
    /// The model's context window size.
    pub max_tokens: u64,
    /// A model `name` to substitute when calling tools, in case the primary model doesn't support tool calling.
...
#[with_fallible_options]
#[derive(Default, Clone, Debug, Serialize, Deserialize, PartialEq, JsonSchema, MergeFrom)]
pub struct VelaDotDevSettingsContent {
    pub available_models: Option<Vec<VelaDotDevAvailableModel>>,
}

#[with_fallible_options]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, JsonSchema, MergeFrom)]
pub struct VelaDotDevAvailableModel {
    /// The provider of the language model.
    pub provider: VelaDotDevAvailableProvider,
...
pub enum VelaDotDevAvailableProvider {
    Anthropic,
    OpenAi,
    Google,
}
