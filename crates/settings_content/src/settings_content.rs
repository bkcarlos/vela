...
pub struct SettingsContent {
    ...
    /// Configuration of audio in Vela.
    ...
    /// This base keymap settings adjusts the default keybindings in Vela to be similar
    /// to other common code editors. By default, Vela's keymap closely follows VSCode's
    ...
    // Settings related to calls in Vela
    pub calls: Option<CallSettingsContent>,

    /// Settings for the which-key popup.
    pub which_key: Option<WhichKeySettingsContent>,

    /// Settings related to Vim mode in Vela.
...
pub enum ProfileBase {
    ...
    #[default]
    User,
    /// Apply profile settings on top of Vela's default settings, ignoring user customizations.
    Default,
}
...
pub struct TelemetrySettingsContent {
    ...
    /// Send anonymized usage data like what languages you're using Vela with.
    ///
    /// Default: true
...
pub struct DebuggerSettingsContent {
    ...
    /// Whether the breakpoints should be reused across Vela sessions.
    ///
    /// Default: true
    ...
    /// Whether to log messages between active debug adapters and Vela
    ///
    /// Default: true
...
/// Configuration of voice calls in Vela.
#[with_fallible_options]
#[derive(Clone, PartialEq, Default, Serialize, Deserialize, JsonSchema, MergeFrom, Debug)]
...
pub struct FileFinderSettingsContent {
    ...
    /// Only the file Vela had indexed will be used, not necessary all the gitignored files.
    ///
    /// Default: Smart
...
pub enum IncludeIgnoredContent {
    ...
    All,
    /// Use only the files Vela had indexed
    Indexed,
...
pub struct RemoteSettingsContent {
    ...
    ///
    /// When unset, Vela auto-detects BuildKit by probing for the `buildx` CLI
