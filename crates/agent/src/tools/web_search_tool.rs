...
use gpui::{App, Task};
use language_model::{
    LanguageModelProviderId, LanguageModelToolResultContent, VELA_CLOUD_PROVIDER_ID,
};
...
impl AgentTool for WebSearchTool {
    ...
    /// We currently only support Vela Cloud as a provider.
    fn supports_provider(provider: &LanguageModelProviderId) -> bool {
        provider == &VELA_CLOUD_PROVIDER_ID
    }
