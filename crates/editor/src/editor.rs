...
use client::{Collaborator, ParticipantIndex, parse_vela_link};
use clock::ReplicaId;
...
pub use vela_actions::editor::RevealInFileManager;
...
impl Editor {
    ...
    fn initialize_new_minimap(
        ...
        const MINIMAP_FONT_FAMILY: SharedString = SharedString::new_static(".VelaMono");
