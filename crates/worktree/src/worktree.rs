...
///
/// Has an absolute path, and may be set to be visible in Vela UI or not.
...
/// * a directory opened in Vela — may be added as a visible entry to the current worktree
///
...
impl BackgroundScanner {
    ...
    async fn process_events(&self, mut events: Vec<PathEvent>) {
        ...
        //
        // Certain directories may have FS changes, but do not lead to git data changes that Vela cares about.
        // Ignore these, to avoid Vela unnecessarily rescanning git metadata.
