...
impl ProjectEnvironment {
    ...
    /// Returns the inherited CLI environment, if this project was opened from the Vela CLI.
...
fn set_origin_marker(env: &mut HashMap<String, String>, origin: EnvironmentOrigin) {
    env.insert(VELA_ENVIRONMENT_ORIGIN_MARKER.to_string(), origin.into());
}

const VELA_ENVIRONMENT_ORIGIN_MARKER: &str = "VELA_ENVIRONMENT";
