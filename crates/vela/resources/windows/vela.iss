...
AppPublisher=Vela Industries
AppPublisherURL=https://www.vela.dev/
AppSupportURL=https://www.vela.dev/
AppUpdatesURL=https://www.vela.dev/
...
[Files]
Source: "{#ResourcesDir}\Vela.exe"; DestDir: "{code:GetInstallDir}"; Flags: ignoreversion
...
; URI Scheme
Root: HKCU; Subkey: "Software\Classes\vela"; ValueType: "string"; ValueData: "URL:vela Protocol"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\Classes\vela"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCU; Subkey: "Software\Classes\vela\DefaultIcon"; ValueType: "string"; ValueData: "{app}\Vela.exe,1"
Root: HKCU; Subkey: "Software\Classes\vela\shell\open\command"; ValueType: "string"; ValueData: """{app}\Vela.exe"" ""%1"""
...
begin
  if WizardIsTaskSelected('addcontextmenufiles') then begin
    ShellExec('', 'powershell.exe', '-Command ' + AddQuotes('Add-AppxPackage -Path ''' + ExpandConstant('{app}\appx\vela_explorer_command_injector.appx') + ''' -ExternalLocation ''' + ExpandConstant('{app}\appx') + ''''), '', SW_HIDE, ewWaitUntilTerminated, AddAppxPackageResultCode);
