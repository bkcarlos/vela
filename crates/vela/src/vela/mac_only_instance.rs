...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Vela Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Vela Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Vela Editor Preview Instance Running",
        ReleaseChannel::Stable => "Vela Editor Stable Instance Running",
    }
}
