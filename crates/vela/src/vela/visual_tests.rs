...
//! Visual testing infrastructure for Vela.
//!
//! This module provides utilities for visual regression testing of Vela's UI.
//! It allows capturing screenshots of the real Vela application window and comparing
...
//! cargo test -p vela visual_tests -- --ignored --test-threads=1
//!
//! # Update baselines when UI intentionally changes
//! UPDATE_BASELINES=1 cargo test -p vela visual_tests -- --ignored --test-threads=1
//! ```
//!
//! ## Screenshot Output
//!
...
/// Initialize a visual test context with all necessary Vela subsystems.
...
mod tests {
    ...
    /// This test captures a screenshot of an empty Vela workspace.
    ///
