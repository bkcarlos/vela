...
use vela_actions::{Quit, assistant, debug_panel, dev, git_panel, project_panel};

pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    let mut view_items = vec![
        MenuItem::action(
            "Zoom In",
            vela_actions::IncreaseBufferFontSize { persist: false },
        ),
        MenuItem::action(
            "Zoom Out",
            vela_actions::DecreaseBufferFontSize { persist: false },
        ),
        MenuItem::action(
            "Reset Zoom",
            vela_actions::ResetBufferFontSize { persist: false },
        ),
        MenuItem::action(
            "Reset All Zoom",
            vela_actions::ResetAllZoom { persist: false },
        ),
        MenuItem::separator(),
    ...
    vec![
        Menu {
            ...
            disabled: false,
            items: vec![
                MenuItem::action("About Vela", vela_actions::About),
                MenuItem::action("Check for Updates", auto_update::Check),
                MenuItem::separator(),
                MenuItem::submenu(Menu::new("Settings").items([
                    MenuItem::action("Open Settings", vela_actions::OpenSettings),
                    MenuItem::action("Open Settings File", super::OpenSettingsFile),
                    MenuItem::action("Open Project Settings", vela_actions::OpenProjectSettings),
                    MenuItem::action("Open Project Settings File", super::OpenProjectSettingsFile),
                    MenuItem::action("Open Default Settings", super::OpenDefaultSettings),
                    MenuItem::separator(),
                    MenuItem::action("Open Keymap", vela_actions::OpenKeymap),
                    MenuItem::action("Open Keymap File", vela_actions::OpenKeymapFile),
                    MenuItem::action("Open Default Key Bindings", vela_actions::OpenDefaultKeymap),
                    MenuItem::separator(),
                    MenuItem::action(
                        "Select Theme...",
                        vela_actions::theme_selector::Toggle::default(),
                    ),
                    MenuItem::action(
                        "Select Icon Theme...",
                        vela_actions::icon_theme_selector::Toggle::default(),
                    ),
                ])),
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                ...
                MenuItem::separator(),
                MenuItem::action("Extensions", vela_actions::Extensions::default()),
                #[cfg(not(target_os = "windows"))]
                MenuItem::action("Install CLI", install_cli::InstallCliBinary),
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Vela", super::Hide),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Others", super::HideOthers),
                #[cfg(target_os = "macos")]
                MenuItem::action("Show All", super::ShowAll),
                MenuItem::separator(),
                MenuItem::action("Quit Vela", Quit),
            ],
        },
        Menu {
            name: "File".into(),
            ...
            items: vec![
                ...
                MenuItem::action("Open Recent…", vela_actions::OpenRecent::default()),
                MenuItem::action("Open Remote…", vela_actions::OpenRemote::default()),
                MenuItem::separator(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::separator(),
                MenuItem::action("Command Palette...", vela_actions::command_palette::Toggle),
                MenuItem::separator(),
        ...
        Menu {
            ...
            items: vec![
                MenuItem::action(
                    "Spawn Task",
                    vela_actions::Spawn::ViaModal {
                        reveal_target: None,
                    },
                ),
                MenuItem::action("Start Debugger", debugger_ui::Start),
                MenuItem::separator(),
                MenuItem::action("Edit tasks.json…", vela_actions::OpenProjectTasks),
                MenuItem::action("Edit debug.json…", vela_actions::OpenProjectDebugTasks),
                MenuItem::separator(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action("View Telemetry", vela_actions::OpenTelemetryLog),
                MenuItem::action("View Dependency Licenses", vela_actions::OpenLicenses),
                MenuItem::action("Show Welcome", onboarding::ShowWelcome),
                MenuItem::separator(),
                MenuItem::action("File Bug Report...", vela_actions::feedback::FileBugReport),
                MenuItem::action("Request Feature...", vela_actions::feedback::RequestFeature),
                MenuItem::action("Email Us...", vela_actions::feedback::EmailVela),
                MenuItem::separator(),
                MenuItem::action(
                    "Documentation",
                    super::OpenBrowser {
                        url: "https://vela.dev/docs".into(),
                    },
                ),
                MenuItem::action("Vela Repository", feedback::OpenVelaRepo),
                MenuItem::action(
                    "Vela Twitter",
                    super::OpenBrowser {
                        url: "https://twitter.com/veladotdev".into(),
                    },
                ),
                MenuItem::action(
                    "Join the Team",
                    super::OpenBrowser {
                        url: "https://vela.dev/jobs".into(),
                    },
                ),
            ],
        },
