...
use crate::{EditPredictionStore, VelaPredictUpsell};
...
/// Introduces user to Vela's Edit Prediction feature
pub struct VelaPredictModal {
                ...
                onboarding: cx.new(|cx| {
                    EditPredictionOnboarding::new(
                        ...
                        Arc::new({
                            ...
                            move |_window, cx| {
                                VelaPredictUpsell::set_dismissed(true, cx);
                                set_edit_prediction_provider(EditPredictionProvider::Vela, cx);
...
impl EventEmitter<DismissEvent> for VelaPredictModal {}

impl Focusable for VelaPredictModal {
    fn focus_handle(&self, _cx: &App) -> FocusHandle {
        self.focus_handle.clone()
    }
}

impl ModalView for VelaPredictModal {
...
impl Render for VelaPredictModal {
