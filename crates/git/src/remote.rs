...
mod tests {
    ...
    fn test_parsing_valid_remote_urls() {
        let valid_urls = vec![
            (
                "https://github.com/octocat/vela.git",
                "https",
                "github.com",
                "/octocat/vela.git",
            ),
            (
                "https://jlannister@github.com/octocat/vela.git",
                "https",
                "github.com",
                "/octocat/vela.git",
            ),
            (
                "git@github.com:octocat/vela.git",
                "ssh",
                "github.com",
                "/octocat/vela.git",
            ),
            (
                "org-000000@github.com:octocat/vela.git",
                "ssh",
                "github.com",
                "/octocat/vela.git",
            ),
            ...
            (
                "ssh://git@github.com/octocat/vela.git",
                "ssh",
                "github.com",
                "/octocat/vela.git",
            ),
            (
                "file:///path/to/local/vela",
                "file",
                "",
                "/path/to/local/vela",
            ),
