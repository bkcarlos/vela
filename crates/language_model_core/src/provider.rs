...
pub const VELA_CLOUD_PROVIDER_ID: LanguageModelProviderId =
    LanguageModelProviderId::new("vela.dev");
pub const VELA_CLOUD_PROVIDER_NAME: LanguageModelProviderName =
    LanguageModelProviderName::new("Vela");
...
pub fn provider_name_for_id(provider_id: &LanguageModelProviderId) -> LanguageModelProviderName {
    if provider_id == &OPEN_AI_PROVIDER_ID {
        ...
        X_AI_PROVIDER_NAME
    } else if provider_id == &VELA_CLOUD_PROVIDER_ID {
