...
mod tests {
    ...
    #[test]
    fn test_mermaid_font_family_resolves_vela_virtual_fonts() {
        assert_eq!(
            super::mermaid_font_family(".VelaSans"),
            "IBM Plex Sans, sans-serif"
        );
        assert_eq!(
            super::mermaid_font_family("Vela Plex Sans"),
            "IBM Plex Sans, sans-serif"
        );
        assert_eq!(super::mermaid_font_family(".VelaMono"), "Lilex, sans-serif");
        assert_eq!(
