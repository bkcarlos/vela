...
use crate::{
    CsvPreviewView,
    settings::{FilterSortOrder, CsvPreviewSettings, VerticalAlignment},
};
...
fn toggle_entry(
    ...
    set: impl Fn(&mut CsvPreviewSettings) + 'static,
) -> ContextMenu {
    ...
    let menu = toggle_entry(
        ...
        Some(
            "Dev-only section used for debugging purposes.\n\
             Will be removed on public release of the CSV feature",
        ),
