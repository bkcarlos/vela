...
// If the vela binary doesn't use anything in this crate, it will be optimized away
...
/// Opens a vela:// URL within the application.
#[derive(Clone, PartialEq, Deserialize, JsonSchema, Action)]
#[action(namespace = vela)]
#[serde(deny_unknown_fields)]
pub struct OpenVelaUrl {
    pub url: Arc<str>,
}
...
#[action(namespace = vela, no_json, no_register)]
...
actions!(
    ...
    [
        ...
        #[action(deprecated_aliases = ["vela_actions::OpenSettingsEditor"])]
        OpenSettings,
        /// Opens the settings JSON file.
        #[action(deprecated_aliases = ["vela_actions::OpenSettings"])]
        OpenSettingsFile,
        /// Opens project-specific settings.
        #[action(deprecated_aliases = ["vela_actions::OpenProjectSettings"])]
        OpenProjectSettings,
        ...
        #[action(deprecated_aliases = ["vela_actions::OpenKeymap"])]
        OpenKeymapFile,
        /// Opens the keymap editor.
        #[action(deprecated_aliases = ["vela_actions::OpenKeymapEditor"])]
        OpenKeymap,
        ...
        Quit,
        /// Shows information about Vela.
        About,
        /// Opens the documentation website.
        OpenDocs,
        /// Views open source licenses.
        OpenLicenses,
        /// Opens the Vela status page.
        OpenStatusPage,
        /// Opens the Vela merch store.
        GetMerch,
...
pub struct CreateWorktree {
    /// When this is None, Vela will randomly generate a worktree name.
...
pub mod feedback {
    ...
    actions!(
        feedback,
        [
            /// Opens email client to send feedback to Vela support.
            EmailVela,
...
pub struct Rerun {
    ...
    /// If it is not, environment variables such as VELA_COLUMN, VELA_FILE are gonna be the same as in the last execution of a task
...
actions!(
    ...
    [
        /// Opens the Vela Predict onboarding modal.
        OpenVelaPredictOnboarding
    ]
);
actions!(
    git_onboarding,
