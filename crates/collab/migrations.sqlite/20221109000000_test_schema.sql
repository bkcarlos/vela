...
-- If you are not Vela staff you MUST coordinate with a staff member to apply the schema migrations before this PR is merged.
...
CREATE TABLE "channels" (
    ...
    "requires_vela_cla" BOOLEAN NOT NULL DEFAULT FALSE,
