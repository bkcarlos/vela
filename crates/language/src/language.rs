//! The `language` crate provides a large chunk of Vela's language-related
...
/// and potentially persist them to Vela's settings.
#[derive(Debug, Clone)]
...
pub trait LspAdapter: 'static + Send + Sync + DynLspInstaller {
    ...
    /// provide autocompletion and diagnostics in Vela setting and keybind
    /// files
    fn is_primary_vela_json_schema_adapter(&self) -> bool {
        false
    }
    ...
    LI: LspInstaller<BinaryVersion = BinaryVersion> + LspAdapter,
{
    ...
    fn get_language_server_command(
        ...
        async move {
            ...
            //      worktree 3: no gopls found in PATH -> fallback to Vela installation
            //
...
impl LanguageScope {
    ...
    ///
    /// By default, Vela treats as paragraph and comment prefixes as boundaries.
    ...
    ///
    /// By default, Vela treats alphanumeric characters (and '_') as word characters for
