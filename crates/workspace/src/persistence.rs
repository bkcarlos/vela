    ...
    const MIGRATIONS: &[&str] = &[
        sql!(
            CREATE TABLE workspaces(
                ...
                dock_visible INTEGER, // Deprecated. Preserving so users can downgrade Vela.
                dock_anchor TEXT, // Deprecated. Preserving so users can downgrade Vela.
                dock_pane INTEGER, // Deprecated.  Preserving so users can downgrade Vela.
        ...
        // Preserving so users can downgrade Vela.
        sql!(
...
impl WorkspaceDb {
    ...
    // session was closed (i.e. when Vela was quit).
