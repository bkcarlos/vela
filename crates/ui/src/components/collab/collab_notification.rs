            ...
            single_example(
                ...
                container()
                    .child(
                        ...
                        .child(Label::new("vela").color(Color::Muted)),
                    )
                    .into_any_element(),
            ),
            single_example(
                ...
                container()
                    .child(
                        ...
                        .child(Label::new(
                            "a_very_long_username_that_might_overflow is sharing a project in Vela:",
                        ))
                        .child(
                            Label::new("vela-cloud, vela, edit-prediction-bench, vela.dev")
                                .color(Color::Muted),
                        ),
                    )
                    .into_any_element(),
            ...
            single_example(
                ...
                container()
                    .child(
                        ...
                        .child(Label::new(
                            "maxbrunsfeld invited you to join the #vela channel",
                        )),
                    )
                    .into_any_element(),
            ),
