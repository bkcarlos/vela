...
//!   (still using Vela's shipped default content) are skipped so we don't
...
//! downgrades to a Vela build without skills support won't lose anything.
...
///    built-ins are skipped so we don't write Vela's shipped default text
