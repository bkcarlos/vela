...
use vela_actions::{OpenDocs, RevealTarget};
...
fn generate_commands(_: &App) -> Vec<VimCommand> {
    vec![
        ...
        VimCommand::new(("cq", "uit"), vela_actions::Quit),
        VimCommand::new(
            ("bd", "elete"),
        ...
        VimCommand::str(("opt", "ions"), "vela::OpenDefaultSettings"),
...
impl OnMatchingLines {
    // convert a vim query into something more usable by vela.
