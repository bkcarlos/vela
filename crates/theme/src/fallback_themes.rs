...
/// The default theme family for Vela.
///
...
pub fn vela_default_themes() -> ThemeFamily {
    ThemeFamily {
        id: "vela-default".to_string(),
        name: "Vela Default".into(),
        author: "".into(),
        themes: vec![vela_default_dark()],
...
pub(crate) fn vela_default_dark() -> Theme {
