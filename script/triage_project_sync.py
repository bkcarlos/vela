...
Sync triage state from `vela-industries/vela` issues into the
"Vela weekly triage" project (#84).
...
from the `VELA_COMMUNITY_BOT_APP_ID` GitHub App, scoped to
`owner: vela-industries`, with `Organization Projects: Read and write`.
