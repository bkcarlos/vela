...
```
❌ "Vela is fast — really fast — and it shows in every interaction."
✅ "Vela is fast. You'll feel it in every interaction."
```
...
✅ "Vela combines editing, collaboration, and AI assistance in one workspace."
```
...
✅ "Vela is built for speed and collaboration."
```

### Colon-Introduced Lists in Prose

```
❌ "Three things make Vela different: speed, collaboration, and AI."
✅ "Vela prioritizes speed, real-time collaboration, and AI integration."
```
...
✅ "Vela renders every keystroke instantly."
```
