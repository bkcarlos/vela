...
description: "Debugger Extensions for Vela extensions."
---
...
Vela offers an automatic way to create debug scenarios with _debug locators_.
...
See DAP servers published as extensions [on Vela's site](https://vela.dev/extensions?filter=debug-adapters).
