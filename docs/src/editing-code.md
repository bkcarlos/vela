---
title: Editing Code in Vela
description: Core code editing features in Vela including multi-cursor, refactoring, code actions, and language server integration.
---

# Editing Code

Vela provides tools to help you write and modify code efficiently. This section covers the core editing features that work alongside your language server.
...
When you're editing code, Vela combines input from multiple sources:
