---
title: Building Vela for FreeBSD
description: "Guide to building vela for freebsd for Vela development."
---

# Building Vela for FreeBSD
...
- Install the necessary system packages and rustup:
  ...
  If preferred, you can inspect [`script/freebsd`](https://github.com/vela-industries/vela/blob/main/script/freebsd) and perform the steps manually.
...
See [Issue #15309: FreeBSD Support] and [Discussion #29550: Unofficial FreeBSD port for Vela] for more.
