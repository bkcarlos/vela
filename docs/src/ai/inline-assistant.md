---
title: Inline AI Code Editing - Vela
description: Transform code inline with AI in Vela. Send selections to any LLM for refactoring, generation, or editing with multi-cursor support.
---
...
1. [using Vela-hosted models](../account/vela-hosted-models.md), so you have access to models billed through Vela
...
[External Agents](./external-agents.md) run in agent threads, but they are not available for Inline Assistant generations. The Inline Assistant uses Vela-configured [LLM providers](./llm-providers.md), including Vela-hosted models, provider API keys, gateways, local models, and supported subscriptions.
...
Here's how you can customize your settings file ([how to edit](../configuring-vela.md#settings-files)) to add this functionality:
...
- **[Edit Prediction](./edit-prediction.md)**: Vela automatically suggests edits based on your recent changes, visited files, and cursor position. No prompting required.
