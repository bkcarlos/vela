...
| [Agent tools](./tools.md), [MCP](./mcp.md), and integrations | Zed, configured MCP servers, and external systems | Tools can read, edit, search, run commands, fetch URLs, or call external systems depending on provider compatibility, project trust, MCP server, and tool permission settings.                                                 | [Tool Permissions](./tool-permissions.md), [MCP](./mcp.md)                                       |
