---
title: LLM Providers - Vela
description: Choose how Vela gets language models: Vela-hosted models, API access, subscriptions, gateways, or local models.
---

# LLM Providers

Use this page to choose which models power [the Vela Agent](./vela-agent.md) and
other Vela-owned AI features, including [Inline Assistant](./inline-assistant.md),
...
| ----------------------------------------------------------------- | --------------------------------------------------------------------- | ------------------------------------- |
| [Use Vela-Hosted Models](../account/vela-hosted-models.md)          | You want models billed through Vela                                    | Account & Billing > Vela-Hosted Models |
...
the difference between the Vela Agent, External Agents, and Terminal Threads.

## Edit Prediction {#edit-prediction}

[Edit Prediction](./edit-prediction.md) has its own provider setup under `edit_predictions`. LLM providers on this page apply to model-backed Vela AI features such as Vela Agent, Inline Assistant, Git commit generation, and thread summaries.
