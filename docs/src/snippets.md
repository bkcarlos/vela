---
title: Snippets - Vela
description: Create and use code snippets in Vela with tab stops, placeholders, variables, and language-scoped triggers.
---
...
The snippets are located in `~/.config/vela/snippets` directory to which you can navigate with the {#action snippets::OpenFolder} action.
