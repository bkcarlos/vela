---
title: Astro
description: "Configure Astro language support in Vela, including language servers, formatting, and debugging."
---

# Astro

Astro support is available through the [Astro extension](https://github.com/vela-extensions/astro).
