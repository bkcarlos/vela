---
title: Proto
description: "Configure Proto language support in Vela, including language servers, formatting, and debugging."
---

# Proto

Proto/proto3 (Protocol Buffers definition language) support is available through the [Proto extension](https://github.com/vela-industries/vela/tree/main/extensions/proto).
...
Or you can have vela directly invoke `clang-format` by specifying it as a [formatter](https://vela.dev/docs/reference/all-settings#formatter) in your settings:
