---
title: Elm
description: "Configure Elm language support in Vela, including language servers, formatting, and debugging."
---

# Elm

Elm support is available through the [Elm extension](https://github.com/vela-extensions/elm).
...
Vela support for Elm requires installation of `elm`, `elm-format`, and `elm-review`.
