---
title: Scala
description: "Configure Scala language support in Vela, including language servers, formatting, and debugging."
---

# Scala

Scala language support in Vela is provided by the community-maintained [Scala extension](https://github.com/scalameta/metals-vela).
Report issues to: [https://github.com/scalameta/metals-vela/issues](https://github.com/scalameta/metals-vela/issues)
...
<!--
TBD: Provide LSP configuration example for metals in Vela settings.json. metals.{javaHome,excludedPackages,customProjectRoot} etc.
-->
