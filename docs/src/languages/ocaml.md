---
title: OCaml
description: "Configure OCaml language support in Vela, including language servers, formatting, and debugging."
---

# OCaml

OCaml support is available through the [OCaml extension](https://github.com/vela-extensions/ocaml).
...
If you have the development environment already set up, you can skip to [Launching Vela](#launching-vela)
...
With that aside, we can now launch Vela. Given how the OCaml package manager works, we require you to run Vela from the terminal, so please make sure you install the [Vela cli](https://vela.dev/features#cli) if you haven't already.
...
You should now have Vela running with OCaml support, with no additional setup required.
