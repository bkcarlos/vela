---
title: Svelte
description: "Configure Svelte language support in Vela, including language servers, formatting, and debugging."
---

# Svelte

Svelte support is available through the [Svelte extension](https://github.com/vela-extensions/svelte).
...
When inlay hints are enabled in Vela, to make the language server send them back, Vela sets the following initialization options:
