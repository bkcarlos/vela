---
title: JavaScript
description: "Configure JavaScript language support in Vela, including language servers, formatting, and debugging."
---

# JavaScript

JavaScript support is available natively in Vela.
...
Configure formatting in Settings ({#kb vela::OpenSettings}) under Languages > JavaScript, or add to your settings file:
...
Vela supports JSX syntax highlighting out of the box.

In JSX strings, the [`tailwindcss-language-server`](./tailwindcss.md) is used to provide autocompletion for Tailwind CSS classes.

## JSDoc

Vela supports JSDoc syntax in JavaScript and TypeScript comments that match the JSDoc syntax.
Vela uses [tree-sitter/tree-sitter-jsdoc](https://github.com/tree-sitter/tree-sitter-jsdoc) for parsing and highlighting JSDoc.

## ESLint

You can configure Vela to format code using `eslint --fix` by running the ESLint code action when formatting.

Configure code actions on format in Settings ({#kb vela::OpenSettings}) under Languages > JavaScript, or add to your settings file:
...
Configure in Settings ({#kb vela::OpenSettings}) under Languages > JavaScript, or add to your settings file:
...
Vela supports debugging JavaScript code out of the box with `vscode-js-debug`.
...
[
  {
    ...
    "type": "chrome",
    "request": "launch",
    "file": "$VELA_WORKTREE_ROOT/index.html",
