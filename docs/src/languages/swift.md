---
title: Swift
description: "Configure Swift language support in Vela, including language servers, formatting, and debugging."
---

# Swift

Swift language support in Vela is provided by the community-maintained [Swift extension](https://github.com/vela-extensions/swift).
Report issues to: [https://github.com/vela-extensions/swift/issues](https://github.com/vela-extensions/swift/issues)
...
Vela's name for the adapter (in the UI and `debug.json`) is `Swift`, and under the hood it uses [`lldb-dap`](https://github.com/swiftlang/llvm-project/blob/next/lldb/tools/lldb-dap/README.md), as provided by the Swift toolchain.
...
[
  {
    ...
    "program": "$VELA_WORKTREE_ROOT/swift-app/.build/arm64-apple-macosx/debug/swift-app",
    "request": "launch",
    "adapter": "Swift"
  }
]
