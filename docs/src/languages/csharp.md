...
C# support is available through the [C# extension](https://github.com/vela-extensions/csharp).
...
Roslyn is enabled by default. To switch to csharp-ls or OmniSharp, add the following to your Vela settings file:
...
csharp-ls can be configured in a Vela settings file with:
...
OmniSharp can be configured in a Vela settings file with:
