---
title: Bash
description: "Configure Bash language support in Vela, including language servers, formatting, and debugging."
---

# Bash

Bash support is available natively in Vela.
...
- [Vela Docs: Language Support: Shell Scripts](./sh.md)
