---
title: Rego
description: "Configure Rego language support in Vela, including language servers, formatting, and debugging."
---

# Rego

Rego language support in Vela is provided by the community-maintained [Rego extension](https://github.com/StyraInc/vela-rego).
