---
title: Erlang
description: "Configure Erlang language support in Vela, including language servers, formatting, and debugging."
---

# Erlang

Erlang support is available through the [Erlang extension](https://github.com/vela-extensions/erlang).
...
Configure language servers in Settings ({#kb vela::OpenSettings}) under Languages > Erlang, or add to your settings file:
