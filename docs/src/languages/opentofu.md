---
title: OpenTofu
description: "Configure OpenTofu language support in Vela, including language servers, formatting, and debugging."
---

# OpenTofu

OpenTofu support is available through the [OpenTofu extension](https://github.com/ashpool37/vela-extension-opentofu).
