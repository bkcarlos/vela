---
title: Extensions
description: "Extend Vela with themes, language support, AI tools, and more through the extension system."
---

# Extensions

Vela lets you add new functionality using user-defined extensions.
