---
title: Roles - Vela
description: Understand Vela's organization roles and what each role can access, manage, and configure.
---

# Roles

Every member of a Vela organization is assigned a role that determines what they
...
- Disable Vela's collaborative features
- Control whether members can use Vela-hosted models and Vela's edit predictions
...
Vela-hosted AI models or Edit Predictions through the Business subscription.
...
Members have standard access to Vela through the Business subscription. They
cannot access billing or organization settings.

## Managing User Roles {#managing-users}

Owners and Admins can manage organization members from the Vela dashboard within
the Members page.
...
Removing a member removes their access to organization settings and any organization-managed features. They can continue using Vela on their own.
