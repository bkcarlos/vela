---
title: Privacy for Business - Vela Business
description: How Vela Business handles data privacy across your organization, including enforced protections for prompts and training data.
---

# Privacy for Business

Vela Business removes the per-member data-sharing options that Free and Pro
...
For all members of a Vela Business organization:

- **No prompt sharing:** Conversations and prompts are never shared with Vela.
...
- **No training data sharing:** Code context is never shared with Vela for
...
- Disable Vela-hosted models entirely via the Vela Model Provider toggle, so no
  prompts reach Vela's infrastructure
